...
export default function CigaretteOrderScreen() {
  ...
  const handleSubmit = async () => {
    if (!details.trim()) {
      Alert.alert('ত্রুটি', 'সিগারেটের নাম ও পরিমাণ লিখুন');
      return;
    }
    if (!address.trim()) {
  ...
  return (
    ...
    >
      <Text style={styles.heading}>আপনার সিগারেট অর্ডার করুন</Text>
      ...
      {/* Details */}
      <Text style={[styles.label, { marginTop: 16 }]}>সিগারেটের নাম ও পরিমাণ</Text>
      <View style={styles.textAreaWrap}>
        <TextInput
          style={styles.textArea}
          placeholder="আপনি সিগারেটের নাম ও পরিমাণ লিখুন (যেমন: ১ প্যাকেট বেনসন ইত্যাদি)"
      ...
      <View style={styles.inputWrap}>
        ...
        <TextInput
          style={styles.input}
          placeholder="ডেলিভারি অ্যাড্রেস দিন"
          placeholderTextColor="#aaa"
          value={address}
